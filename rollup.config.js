...
const platform = {
  core: [
    {
      dist: 'lib',
      path: 'src/leafer/packages/core/core',
      withMin: 'min',
      withFormat: ['cjs'],
    },
    {
  ...
  in: [
    ...
    {
      name: 'scroller',
      path: inPath + '/scroller',
      withGlobal: 'LeaferIN.scroller',
      withMin: 'min',
      withFormat: ['cjs'],
      external: pluginExternal,
    },
